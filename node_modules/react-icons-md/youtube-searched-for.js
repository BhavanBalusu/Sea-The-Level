        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'g',
                    null,
                    React.createElement('path', { d: 'm28.4 23.4l8.2 8.2-2.4 2.5-8.3-8.3v-1.3l-0.5-0.4c-1.9 1.6-4.4 2.5-7 2.5-2.1 0-3.9-0.5-5.6-1.4l2.5-2.5c1 0.4 2 0.7 3.1 0.7 4.1 0 7.5-3.4 7.5-7.5s-3.4-7.5-7.5-7.5-7.5 3.3-7.5 7.5h5.7l-6.8 6.6-6.4-6.6h4.1c0-5.9 4.8-10.9 10.9-10.9s10.8 4.8 10.8 10.9c0 2.7-1 5.1-2.6 7l0.4 0.5h1.4z' })
                )
            );
        }
    }]);
